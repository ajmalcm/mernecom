...
export const updateProduct=(id,productDetails)=>async(dispatch)=>{
    try{
        ...
        const {data}=await axios.put(`/api/v1/admin/product/update/${id}`,productDetails,config);
